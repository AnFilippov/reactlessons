        ...
        <Slider {...settings}>
          <section className="swiper-slide promo pizza">
            ...
            <p className="promo-text">
              Блюда из любимого ресторана привезет курьер в перчатках, маске с антисептиком
            </p>
          </section>
          ...
          <section className="swiper-slide promo vegetables">
            ...
            <p className="promo-text">
              Блюдо из ресторана привезут вместе с двумя подарочными книгами по фронтэнду
            </p>
          </section>
